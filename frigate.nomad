locals {
  ...
  go2rtc_configuration = trimspace(
    trimsuffix(
      trimspace(
        regex_replace(
          regex_replace(
  ...
  group "frigate" {
    ...
    task "frigate" {
      ...
      service {
        ...
        meta {
          nginx-config = substr(local.api_configuration, 0, 511)
          nginx-config-1 = substr(local.api_configuration, 511, 511)
          nginx-config-2 = substr(local.api_configuration, 1022, 511)
          nginx-config-3 = substr(local.api_configuration, 1533, 511)
          nginx-config-4 = substr(local.api_configuration, 2044, 511)
          nginx-config-5 = substr(local.api_configuration, 2555, 511)
      ...
      service {
        ...
        meta {
          nginx-config = substr(local.go2rtc_configuration, 0, 511)
          nginx-config-1 = substr(local.go2rtc_configuration, 511, 511)
          nginx-config-2 = substr(local.go2rtc_configuration, 1022, 511)
          nginx-config-3 = substr(local.go2rtc_configuration, 1533, 511)
          nginx-config-4 = substr(local.go2rtc_configuration, 2044, 511)
          nginx-config-5 = substr(local.go2rtc_configuration, 2555, 511)
          nginx-config-6 = substr(local.go2rtc_configuration, 3066, 511)
          nginx-config-7 = substr(local.go2rtc_configuration, 3577, 511)
          nginx-config-8 = substr(local.go2rtc_configuration, 4088, 511)
          firewall-rules = jsonencode(["internet"])
        }
      }
